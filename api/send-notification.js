// api/send-notification.js (Versión que usa "data" para evitar duplicados)
...
function replacePlaceholders(template, data = {}) { /* ... (código sin cambios) ... */ }
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // En lugar de "notification", enviamos todo dentro del campo "data".
    // Esto le da el control total al Service Worker.
    const message = {
      data: {
        title: title,
        body: body,
        // (Opcional) Podemos añadir más datos aquí si los necesitamos en el futuro
      },
      tokens: tokens,
    };
