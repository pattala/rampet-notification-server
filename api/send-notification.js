...
export default async function handler(req, res) {
  // Las cabeceras CORS ahora son manejadas por vercel.json
  // La petición OPTIONS también es manejada por vercel.json, no necesitamos el if aquí.
  ...
  if (req.method === 'POST') {
    ...
    // Si no es POST (y no es OPTIONS manejado por Vercel), es un método no permitido.
